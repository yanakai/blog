...
/**
 * 
  * <p>Title: UserConstants</p>  
  * <p>Description: 用户常量信息</p>  
...
public class UserConstants {
    ...
    /** 文章栏目名称是否唯一的返回结果码 */
    public final static String USER_COLUMN_NAME_UNIQUE = "0";
    public final static String USER_COLUMN_NAME_NOT_UNIQUE = "1";
