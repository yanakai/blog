...
-- ----------------------------
INSERT INTO `sys_login_info` VALUES ('161e47a4-4eeb-4c32-be8f-a1b6bb79882f', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-11-24 22:54:16');
INSERT INTO `sys_login_info` VALUES ('4f81a620-95d0-4801-8c44-bdb4e04dfea5', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-11-24 22:49:37');
INSERT INTO `sys_login_info` VALUES ('7254d2c8-3131-4458-a97e-5b2cb122bd5f', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-11-24 22:58:27');
INSERT INTO `sys_login_info` VALUES ('f3820e68-db11-4a5d-b5b7-857a683ac8ed', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2019-11-24 22:54:10');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES ('7e88319d-d2bc-4fe3-9218-cdf81a269c60', '操作日志-->查询列表', 1, 'com.blog.sys.log.controller.SysOperLogController.tableDataList()', 'POST', 1, 'admin', '', '/sys/operLog/list', '0:0:0:0:0:0:0:1', '内网IP', '{\r\n  \"title\" : [ \"\" ],\r\n  \"operName\" : [ \"adm\" ],\r\n  \"params[beginTime]\" : [ \"\" ],\r\n  \"params[endTime]\" : [ \"\" ],\r\n  \"pageSize\" : [ \"10\" ],\r\n  \"pageNum\" : [ \"1\" ],\r\n  \"orderByColumn\" : [ \"oper_time\" ],\r\n  \"isAsc\" : [ \"desc\" ]\r\n}', '{\r\n  \"total\" : 1,\r\n  \"rows\" : [ {\r\n    \"params\" : null,\r\n    \"operId\" : \"b54f058c-05a5-42d1-8be6-df7e2c996311\",\r\n    \"title\" : \"操作日志-->清空数据\",\r\n    \"businessType\" : 10,\r\n    \"method\" : \"com.blog.sys.log.controller.SysOperLogController.clean()\",\r\n    \"requestMethod\" : \"POST\",\r\n    \"operatorType\" : 1,\r\n    \"operName\" : \"admin\",\r\n    \"deptName\" : \"\",\r\n    \"operUrl\" : \"/sys/operLog/clean\",\r\n    \"operIp\" : \"0:0:0:0:0:0:0:1\",\r\n    \"operLocation\" : \"内网IP\",\r\n    \"operParam\" : \"{ }\",\r\n    \"jsonResult\" : \"{\\r\\n  \\\"state\\\" : 1,\\r\\n  \\\"msg\\\" : \\\"操作成功\\\",\\r\\n  \\\"data\\\" : null,\\r\\n  \\\"code\\\" : null\\r\\n}\",\r\n    \"status\" : 0,\r\n    \"errorMsg\" : \"\",\r\n    \"operTime\" : 1574606339000\r\n  } ],\r\n  \"code\" : 0\r\n}', 0, '', '2019-11-24 22:38:59');
INSERT INTO `sys_oper_log` VALUES ('ae643dce-6ccc-4012-929b-f59418716411', '登录日志-->查询列表', 1, 'com.blog.sys.log.controller.SysLoginInfoController.tableDataList()', 'POST', 1, 'admin', '', '/sys/loginLog/list', '0:0:0:0:0:0:0:1', '内网IP', '{\r\n  \"pageSize\" : [ \"10\" ],\r\n  \"pageNum\" : [ \"1\" ],\r\n  \"orderByColumn\" : [ \"login_time\" ],\r\n  \"isAsc\" : [ \"desc\" ],\r\n  \"ipaddr\" : [ \"\" ],\r\n  \"loginName\" : [ \"\" ],\r\n  \"params[beginTime]\" : [ \"\" ],\r\n  \"params[endTime]\" : [ \"\" ]\r\n}', '{\r\n  \"total\" : 0,\r\n  \"rows\" : [ ],\r\n  \"code\" : 0\r\n}', 0, '', '2019-11-24 22:39:02');
INSERT INTO `sys_oper_log` VALUES ('b54f058c-05a5-42d1-8be6-df7e2c996311', '操作日志-->清空数据', 10, 'com.blog.sys.log.controller.SysOperLogController.clean()', 'POST', 1, 'admin', '', '/sys/operLog/clean', '0:0:0:0:0:0:0:1', '内网IP', '{ }', '{\r\n  \"state\" : 1,\r\n  \"msg\" : \"操作成功\",\r\n  \"data\" : null,\r\n  \"code\" : null\r\n}', 0, '', '2019-11-24 22:38:59');
INSERT INTO `sys_oper_log` VALUES ('d2d21f44-8ebb-42da-ab74-abe85c646fe4', '登录日志-->清空数据', 10, 'com.blog.sys.log.controller.SysLoginInfoController.clean()', 'POST', 1, 'admin', '', '/sys/loginLog/clean', '0:0:0:0:0:0:0:1', '内网IP', '{ }', '{\r\n  \"state\" : 1,\r\n  \"msg\" : \"操作成功\",\r\n  \"data\" : null,\r\n  \"code\" : null\r\n}', 0, '', '2019-11-24 22:39:02');
...
INSERT INTO `sys_user_info` VALUES ('admin', 'admin', '6e46bc8bfd6617fb29fd152ada99c3dc', '', '超级管理员', '0', NULL, 'yanakai@124.com', 'ba36d3', '0', '/profile/avatar/2019/11/23/d6812ada3902c820b67089c40d76ad7a.png', NULL, NULL, '2019-11-24 22:58:27', '2019-11-16 10:20:16', '0:0:0:0:0:0:0:1');
