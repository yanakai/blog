...
CREATE TABLE `sys_article_info`  (
  `article_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  ...
  `column_id` bigint(10) NULL DEFAULT NULL COMMENT '所属栏目',
  `tag_id` bigint(10) NULL DEFAULT NULL COMMENT '所属标签',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章信息' ROW_FORMAT = Compact;
...
CREATE TABLE `sys_column_info`  (
  `column_id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '主键Id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '栏目信息' ROW_FORMAT = Compact;
...
INSERT INTO `sys_menu_info` VALUES ('051eafd7-2c42-4462-8f67-24f29c2b5946', '在线用户', 'eb2d09f8-5211-4591-8802-3c7231fe90ac', 5, '/sys/online/list', 'menuItem', 'C', '0', 'sys:online:view', '', '暂时没有登录者', '2019-11-27 22:43:56', '暂时没有登录者', '2019-11-27 23:08:02', '');
...
INSERT INTO `sys_menu_info` VALUES ('1a294a6c-b257-43ef-8c2a-37827f5ab5bc', '批量强退', '051eafd7-2c42-4462-8f67-24f29c2b5946', 1, '', 'menuItem', 'F', '0', 'sys:online:batchForceLogout', '', '暂时没有登录者', '2019-12-01 22:44:25', '', NULL, '');
...
INSERT INTO `sys_menu_info` VALUES ('a94e39df-5a43-4182-9c92-314ac8838bf3', '单个强退', '051eafd7-2c42-4462-8f67-24f29c2b5946', 2, '', 'menuItem', 'F', '0', 'sys:online:forceLogout', '', '暂时没有登录者', '2019-12-01 22:45:07', '', NULL, '');
...
INSERT INTO `sys_role_info` VALUES ('7106387b-3bb3-4416-9d79-a2501abadd01', '测试角色', 'test', 1, '1', '0', '0', '暂无登录者', '2019-11-16 14:54:57', '暂无登录者', '2019-12-01 22:38:14', '');
...
-- ----------------------------
INSERT INTO `sys_user_info` VALUES ('9722a28d-a85e-4216-8d51-72da46fe7f25', 'yankai', 'ff210928e31eff77dab8aae4a042cbae', '15538157826', '闫凯', '0', NULL, 'yanakai@127.com', 'a08cc4', '0', NULL, NULL, '2019-11-17 03:24:27', '2019-12-02 09:43:39', '2019-11-24 22:14:50', '127.0.0.1');
INSERT INTO `sys_user_info` VALUES ('admin', 'admin', '6e46bc8bfd6617fb29fd152ada99c3dc', '', '超级管理员', '0', NULL, 'yanakai@124.com', 'ba36d3', '0', '/profile/avatar/2019/11/23/d6812ada3902c820b67089c40d76ad7a.png', NULL, NULL, '2019-12-09 13:53:21', '2019-12-01 22:38:29', '127.0.0.1');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('d1b795e2-0421-4c57-9551-c3edc31745f6', 'admin', NULL, '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2019-12-09 13:15:43', '2019-12-09 13:53:21', 1800000);
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户和角色管理表' ROW_FORMAT = Compact;
