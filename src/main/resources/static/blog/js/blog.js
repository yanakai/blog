    ...
    $.extend({
        ...
        operate: {
            ...
            ajaxSuccess: function (result) {
            	if (result.state == web_status.SUCCESS && table.options.type == table_type.bootstrapTable) {
                	$.modal.msgSuccess(result.msg);
            		$.table.refresh();
                } else if (result.state == web_status.SUCCESS && table.options.type == table_type.bootstrapTreeTable) {
                	$.modal.msgSuccess(result.msg);
                	$.treeTable.refresh();
                } else if (result.state == web_status.WARNING) {
                    $.modal.alertWarning(result.msg)
